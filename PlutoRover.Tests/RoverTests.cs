...
namespace PlutoRover.Tests
{
    ...
    {
        /// <summary>
        /// A grid of 10 columns by 10 rows, containing no obstacles
        /// </summary>
        private static readonly Grid TEN_BY_TEN_EMPTY_GRID = new Grid(width: 10, height: 10);

        [Test]
        public void StartsAtStartingPosition()
        {
            new Rover(Position.Of(0, 0, Direction.N), TEN_BY_TEN_EMPTY_GRID).ReportPosition().Should().Be("0, 0, N");
            new Rover(Position.Of(10, 0, Direction.S), TEN_BY_TEN_EMPTY_GRID).ReportPosition().Should().Be("10, 0, S");
            new Rover(Position.Of(42, 42, Direction.W), TEN_BY_TEN_EMPTY_GRID).ReportPosition().Should().Be("42, 42, W");
        }

        [Test]
        public void GivenForwardCommandWhenFacingNorthMovesNorth()
        {
            Rover testSubject = new Rover(Position.Of(0, 0, Direction.N), TEN_BY_TEN_EMPTY_GRID);
        ...
        {
            Rover testSubject = new Rover(Position.Of(0, 9, Direction.S), TEN_BY_TEN_EMPTY_GRID);
        ...
        {
            Rover testSubject = new Rover(Position.Of(1, 5, Direction.E), TEN_BY_TEN_EMPTY_GRID);
        ...
        {
            Rover testSubject = new Rover(Position.Of(7, 5, Direction.W), TEN_BY_TEN_EMPTY_GRID);
        ...
        {
            Rover testSubject = new Rover(Position.Of(0, 9, Direction.N), TEN_BY_TEN_EMPTY_GRID);
        ...
        {
            Rover testSubject = new Rover(Position.Of(0, 1, Direction.S), TEN_BY_TEN_EMPTY_GRID);
        ...
        {
            Rover testSubject = new Rover(Position.Of(8, 5, Direction.E), TEN_BY_TEN_EMPTY_GRID);
        ...
        {
            Rover testSubject = new Rover(Position.Of(0, 5, Direction.W), TEN_BY_TEN_EMPTY_GRID);
        ...
        {
            Rover testSubject = new Rover(Position.Of(5, 5, Direction.N), TEN_BY_TEN_EMPTY_GRID);
        ...
        {
            new Rover(Position.Of(0, 9, Direction.N), TEN_BY_TEN_EMPTY_GRID)
                .Move("F").Should().Be("0, 0, N");

            new Rover(Position.Of(2, 2, Direction.S), TEN_BY_TEN_EMPTY_GRID)
                .Move("FFFFF").Should().Be("2, 7, S");

            new Rover(Position.Of(0, 0, Direction.W), TEN_BY_TEN_EMPTY_GRID)
                .Move("F").Should().Be("9, 0, W");

            new Rover(Position.Of(8, 0, Direction.E), TEN_BY_TEN_EMPTY_GRID)
        ...
        {
            new Rover(Position.Of(0, 9, Direction.S), TEN_BY_TEN_EMPTY_GRID)
                .Move("B").Should().Be("0, 0, S");

            new Rover(Position.Of(2, 2, Direction.N), TEN_BY_TEN_EMPTY_GRID)
                .Move("BBBBB").Should().Be("2, 7, N");

            new Rover(Position.Of(0, 0, Direction.E), TEN_BY_TEN_EMPTY_GRID)
                .Move("B").Should().Be("9, 0, E");

            new Rover(Position.Of(8, 0, Direction.W), TEN_BY_TEN_EMPTY_GRID)
                .Move("BBB").Should().Be("1, 0, W");
        }

        [Test]
        public void GivenACommandToMoveForwardIntoASquareContainingAnObstacleReportsCurrentPositionAndObstacle()
        {
            Grid gridWithObstacleAtX5Y6 = new Grid(20, 20, Tuple.Create(5, 6));
            Rover testSubject = new Rover(Position.Of(5, 5, Direction.N), gridWithObstacleAtX5Y6);

            testSubject.Move("F").Should().Be("5, 5, N. Obstacle found at (5, 6)");
            testSubject.Move("F").Should().Be("5, 5, N. Obstacle found at (5, 6)");
            testSubject.Move("B").Should().Be("5, 4, N");
            testSubject.Move("FF").Should().Be("5, 5, N. Obstacle found at (5, 6)");
        }

        [Test]
        public void GivenACommandToMoveBackwardIntoASquareContainingAnObstacleReportsCurrentPositionAndObstacle()
        {
            Grid gridWithObstacleAtX5Y6 = new Grid(20, 20, Tuple.Create(5, 6));
            Rover testSubject = new Rover(Position.Of(5, 5, Direction.S), gridWithObstacleAtX5Y6);

            testSubject.Move("B").Should().Be("5, 5, S. Obstacle found at (5, 6)");
            testSubject.Move("B").Should().Be("5, 5, S. Obstacle found at (5, 6)");
            testSubject.Move("F").Should().Be("5, 4, S");
            testSubject.Move("BB").Should().Be("5, 5, S. Obstacle found at (5, 6)");
        }
